    ...
    for (const [key, value] of entries) {
        ...
        if (isObject || isDefaultFunction) {
            ...
            if (typeof value === "function" ) {
                ...
                if (code.includes("not supported by JSPM") || code.includes("unimplemented(")) {
                    visitResult[key] = "undefined";
                    continue;
                }
            }
...
export default {
    async fetch(request, env, ctx) {
        ...
        const assertStrict = await import("assert/strict");
        ...
        const inspectorPromises = await import("inspector/promises");
        const module = await import("module");
        const net = await import("net");
        const os = await import("os");
        const path = await import("path");
        const pathPosix = await import("path/posix");
        const pathWin32 = await import("path/win32");
